...
{{
var G__11657 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11657;
continue;
}
} else
...
{var pred__11661 = cljs.core._EQ_;var expr__11662 = limit;if(cljs.core.truth_(pred__11661.call(null,(1),expr__11662)))
...
{var temp__4404__auto__ = cljs.core.re_find.call(null,re,s__$1);if(cljs.core.truth_(temp__4404__auto__))
{var m = temp__4404__auto__;var index = s__$1.indexOf(m);{
var G__11664 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11665 = (limit__$1 - (1));
var G__11666 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__11664;
limit__$1 = G__11665;
parts = G__11666;
continue;
...
{var ch = s.charAt(index);var temp__4404__auto___11668 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4404__auto___11668))
{var replacement_11669 = temp__4404__auto___11668;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_11669)));
} else
{buffer.append(ch);
}
{
